...
$mail->Host = 'mail.waterloostrata.ca'; // Specify main and backup SMTP servers
$mail->SMTPAuth = true; // Enable SMTP authentication
$mail->Username = 'info@waterloostrata.ca'; // SMTP username
$mail->Password = 'mail@waterloostrata'; // SMTP password
$mail->SMTPSecure = 'tls'; // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587; // TCP port to connect to

$mail->setFrom('info@waterloostrata.ca', $_POST['name']);
$mail->addAddress('ghimireudbhav@gmail.com');

$mail->addReplyTo($_POST['email']);
$mail->isHTML(true);

$mail->Subject = "Strata Condos - Landing Page Inquiry";
$message = '<html>
